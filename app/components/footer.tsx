...
const ExternalLink = ({ href, children }: ExternalLinkProps) => (
  <li>
    <a 
      href={href || "#"} 
      className="flex items-center hover:text-[#FF8040] transition-colors"
      target="_blank"
      ...
      <div className="container mx-auto px-4 max-w-screen-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <nav aria-label="フッターナビゲーション">
            <h3 className="text-[#FF8040] mb-4">Menu</h3>
          ...
          {/* Links Section */}
          <div>
            <h3 className="text-[#FF8040] mb-4">Link</h3>
            <ul className="space-y-4">
              <ExternalLink href="https://0x1.company">公式サイト</ExternalLink>
